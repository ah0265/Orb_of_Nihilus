...
public class PlayerShip_Jupiter : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (score == 6)
        {
            Instantiate(portal, pos.transform.position, Quaternion.identity);
        }
        if (isDead != true)
        {
            ...
            {
                Instantiate(projectile, spawnPos1.position, transform.rotation);
                Instantiate(projectile, spawnPos2.position, transform.rotation);
            }
